...
const en = {
  ...
  footer: {
    ...
    sourceNote:
      'An independent bilingual learning edition inspired by namethatui.com, with original optimizations and adaptations. Source concepts remain credited to their original author.',
...
const zh: typeof en = {
  ...
  footer: {
    ...
    poweredBy: 'Powered by',
    sourceNote:
      '参考 namethatui.com 打造的中英双语学习版，并在此基础上进行了优化与改造；相关原始概念仍归原作者所有。',
    slogan: '看到它 · 核实它 · 命名它',
